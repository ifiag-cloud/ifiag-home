                ...
                <div className="col-12 col-lg-9 mt-5 margin-mobile">
                    <div className='col-11'>
                        ...
                        <div className="ratio ratio-16x9 m-0 ">
                                    ...
                                    <p className='tv-text'>L'équipe de l’institut Français de l’intelligence Artificielle et de la Génétique (IFIAG) sur le terrain dans le 93 avec à sa tête son Président Jean Roger SIQUILINI à la rencontre des personnes afin de mieux les informer et de répondre à leurs différentes questions liées au Numérique.</p>  
                                    <p className='tv-text'>
